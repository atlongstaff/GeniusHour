...
class Cactus(pygame.sprite.Sprite):
    ...
    def update(self):
        print("distance",self.rect.right)
        self.rect = self.rect.move(self.movement)
        self.rect.right     ############################ Nural net inpt #4 ---- Cactus distance ###########################
    ...
    while not gameQuit:
        ...
        while not gameOver:
            ...
            if pygame.display.get_surface() == None:
                ...
                for event in pygame.event.get():
                    ...
                    if event.type == pygame.KEYDOWN: 
                        if event.key == pygame.K_SPACE or event.key == pygame.K_UP:#/##/#/#/#/#/#/#/#/#/#/#/#/#/#/#/#/ Nural net output #1 ---- jumping #/#/#/#/#/#/#/#/#/#/#/#/##/#/#/#/
                        ...
                        if event.key == pygame.K_DOWN: #/##/#/#/#/#/#/#/#/#/#/#/#/#/#/#/#/ Nural net output #2 ---- ducking #/#/#/#/#/#/#/#/#/#/#/#/##/#/#/#/
        ...
        while gameOver:
            if pygame.display.get_surface() == None:
                ...
                for i in range(8):
                    print("game over your high score is",high_score)
                    time.sleep(1)
                for event in pygame.event.get():
                    if event.type == pygame.QUIT:
                        gameQuit = True
