...
def gameplay(gamecount,scorelist,q_table,reward,old_value):
    print(q_table)
    ...
    while not gameQuit:
        ...
        while not gameOver:
            ...
            if random.uniform(0, 1) < epsilon:
                action = random.randint(1,2) # Explore action space
            else:
                action = np.argmax(q_table[state]) # Exploit learned values
            next_state, done, info = (1, True, {'prob': 1.0})
            if old_value == 0:
                old_value+=1
            else:
                old_value = q_table[state, action]

            print(old_value,"oldvalue")
            next_max = np.max(q_table[next_state])
        
            new_value = (1 - alpha) * old_value + alpha * (reward + gamma * next_max) ########resulting in zero... either Old_value, or next_max nead ot change
            ...
            ##########################sigmoid hidden layer 1  ##########################
                ...
                print("new_value",(1 - alpha) * old_value + alpha * (reward + gamma * next_max))

                if action == 1:#/##/#/#/#/#/#/#/#/#/#/#/#/#/#/#/#/ Nural net output #1 ---- jumping #/#/#/#/#/#/#/#/#/#/#/#/##/#/#/#/
                    penalties += 1
                ...
                if action == 2: #/##/#/#/#/#/#/#/#/#/#/#/#/#/#/#/#/ Nural net output #2 ---- ducking #/#/#/#/#/#/#/#/#/#/#/#/##/#/#/#/
                    penalties += 1
            ...
            while gameOver:
                if pygame.display.get_surface() == None:
                    ...
                    gameOver = False
                    gameplay(gamecount,scorelist,q_table,reward,old_value)
...
def main(gamecount,scorelist,q_table,reward,old_value):
    isGameQuit = introscreen()
    if not isGameQuit:
        gameplay(gamecount,scorelist,q_table,reward,old_value)

main(gamecount,scorelist,q_table,reward,old_value)
